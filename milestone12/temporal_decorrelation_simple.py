...
class Temporal_decorrelation_simple(intra_frame_decorrelation.Intra_frame_decorrelation):
    ...
    def pack(self, chunk_number, chunk):
        decomposition = pywt.wavedec(chunk, wavelet=self.wavelet, level=None, mode="per")
...
class Temporal_decorrelation_simple__verbose(Temporal_decorrelation, intra_frame_decorrelation.Intra_frame_decorrelation__verbose):
    def __init__(self):
        super().__init__()
